 ...
 * 
 */
@WebServiceClient(name = "InsulinDoseCalculatorService", targetNamespace = "http://server/", wsdlLocation = "http://10.17.1.6:8080/InsulinDoseCalculator/insulin?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://10.17.1.6:8080/InsulinDoseCalculator/insulin?wsdl");
