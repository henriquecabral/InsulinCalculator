 ...
 * 
 */
@WebServiceClient(name = "InsulinService", targetNamespace = "http://server/", wsdlLocation = "http://10.17.1.7:8081/insulin?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://10.17.1.7:8081/insulin?wsdl");
